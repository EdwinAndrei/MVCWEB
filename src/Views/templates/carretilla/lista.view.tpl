<section style="width:100%; min-height:100vh; background:#f2f2f2; display:flex; justify-content:flex-end;">
    ...
    <div style="width:420px; min-height:100vh; background:white; box-shadow:-4px 0 12px rgba(0,0,0,0.15); display:flex; flex-direction:column;">
        ...
        <div style="border-top:1px solid #ddd; padding:20px; background:#fafafa;">
            ...
            <a href="index.php?page=Carretilla_Carretilla&clear=1" style="display:block; width:100%; background:black; color:white; text-align:center; padding:14px; text-decoration:none; margin-bottom:10px; font-weight:bold;">
                Vaciar carrito
            </a>

            <a href="index.php?page=Checkout_Checkout" style="display:block; width:100%; background:#f39b5f; color:white; text-align:center; padding:14px; text-decoration:none; font-weight:bold;">
                Realizar compra
            </a>

            <a href="index.php?page=Products_Products" style="display:block; width:100%; background:black; color:white; text-align:center; padding:14px; text-decoration:none; margin-bottom:10px; font-weight:bold;">
                Regresar
            </a>
        </div>
